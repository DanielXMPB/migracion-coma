if [ ! -f /tmp/initializated ]; then
    ...
    cp -r /datadrive/backup/eisi.war -d /datadrive/tomcat/webapps/
    ...
    mkdir -p /datadrive/backup/images
    mkdir -p /datadrive/backup/ArchivosProfesores
    ...
    cp -r /datadrive/files/images/* /datadrive/tomcat/webapps/eisi/images/
    cp -r /datadrive/files/ArchivosProfesores/* /datadrive/tomcat/webapps/eisi/ArchivosProfesores/
    ...
    cp -ru /datadrive/tomcat/webapps/eisi/images/* /datadrive/backup/images/
    cp -ru /datadrive/tomcat/webapps/eisi/ArchivosProfesores/* /datadrive/backup/ArchivosProfesores/
    ...
    cp -r /datadrive/backup/images/* /datadrive/tomcat/webapps/eisi/images/
    cp -r /datadrive/backup/ArchivosProfesores/* /datadrive/tomcat/webapps/eisi/ArchivosProfesores/

...
# CIENCIAS
docker compose -f docker-compose-proxy.yml run --rm  certbot certonly --webroot --webroot-path /var/www/certbot/ -d ciencia.uis.edu.co -d bio.uis.edu.co -d fis.uis.edu.co -d mat.uis.edu.co -d quim.uis.edu.co -d summerschool.uis.edu.co -d intercambiovirtual.uis.edu.co -d eisidev01.uis.edu.co -d eisidev02.uis.edu.co
...
# SALUD
docker compose -f docker-compose-proxy.yml run --rm  certbot certonly --webroot --webroot-path /var/www/certbot/ -d enfermeria.uis.edu.co -d fisioterapia.uis.edu.co -d medicina.uis.edu.co -d microbiologia.uis.edu.co -d nutricion.uis.edu.co -d vacadem.uis.edu.co -d caluwebapp.uis.edu.co -d comarealtime.uis.edu.co
